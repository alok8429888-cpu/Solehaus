...
export function FeaturedDrop() {
  ...
  return (
    <section id='drop' className='mx-auto max-w-shell px-5 py-16 md:px-8 md:py-24'>
      <div className='relative overflow-hidden rounded-3xl border border-line bg-surface p-8 md:p-14'>
        ...
        <div className='relative flex flex-col items-start justify-between gap-8 md:flex-row md:items-center'>
          ...
          <div className='flex gap-3'>
            {units.map(([label, val]) => (
              <div
                key={label}
                className='flex min-w-[64px] flex-col items-center rounded-2xl border border-line bg-ink px-3 py-3'
              >
                <span className='font-display text-2xl font-bold tabular-nums text-cream md:text-3xl'>
